...
if sys.platform=='win32':
  pngmath_latex = 'C:/Program Files (x86)/MiKTeX 2.9/miktex/bin/latex.exe' 
  pngmath_dvipng = 'C:/Program Files (x86)/MiKTeX 2.9/miktex/bin/dvipng.exe' 
...
# documentation.
html_theme_options = {'sidebarbgcolor':'rgb(84,84,84)',
                      'sidebarlinkcolor':'white',
                      'sidebartextcolor':'rgb(206,0,0)',
                      'headbgcolor':'rgb(204,204,204)',
                      'headtextcolor':'rgb(206,0,0)',
                      'footerbgcolor':'rgb(109,109,109)',
                      'relbarbgcolor':'rgb(136,136,136)',
                      #'bgcolor':'papayawhip'
                      }
...
# of the sidebar.
html_logo = 'tesla-transp-s.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = 'tesla_logo.ico'
